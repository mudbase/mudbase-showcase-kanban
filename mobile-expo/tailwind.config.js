...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Same token conversion the sibling social port used (web/src/app/globals.css's HSL
        // tokens, translated to hex) so every showcase port reads as one product family.
