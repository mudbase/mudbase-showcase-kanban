...
/// start, and drives login/logout. `state.value == null` means "signed
/// out" - the router's redirect logic (see `router/app_router.dart`) reads
/// this directly to gate every screen behind auth (this app has no
/// anonymous/guest session and no registration flow - see
...
/// social/ecommerce Flutter apps' `features/auth/auth_controller.dart`.
class AuthController extends AsyncNotifier<MudbaseUser?> {
  ...
  // racing each other into failure.
