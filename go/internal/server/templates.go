...
// these back the poll-refreshed portions of the board and activity pages, this app's stand-in for
// the reference web app's Socket.IO realtime subscription: there is no official Mudbase Go
