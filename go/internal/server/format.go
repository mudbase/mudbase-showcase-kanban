...
// uses everywhere a real profile photo would go - there is no `users` collection (see
// plan/build-plan.md), so an assignee is just a typed name. Ported from the reference web app's
// src/lib/utils.ts (initials).
