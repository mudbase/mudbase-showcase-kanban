...
/// <summary>
/// Attached (see Program.cs's ConfigureApi wiring) to every HttpClient the generated Mudbase SDK
/// uses. A Mudbase access token is short-lived; without this handler, any page whose session
...
/// original 401 is returned untouched and RequireMudbaseSessionMiddleware sends the visitor back to
/// /Login on their next request since the session no longer has a usable token.
/// </summary>
