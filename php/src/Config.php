 ...
 * once per process and exposes required/optional lookups. Ported verbatim from the social PHP
 * port — same fail-fast behavior as the reference Next.js app's src/lib/config.ts (requireEnv
 * throws immediately on a missing var instead of letting the app boot broken).
 */
final class Config
{
