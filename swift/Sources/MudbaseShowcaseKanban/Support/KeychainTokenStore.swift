...
/// Persists the Mudbase access + refresh token pair in the iOS/macOS Keychain. Never
/// `UserDefaults` — that is a hard security rule for this project (tokens in `UserDefaults` are
/// readable from an unencrypted plist on jailbroken devices and in local device backups). Ported
/// verbatim from the sibling Swift ports' `Support/KeychainTokenStore.swift`.
struct KeychainTokenStore: Sendable {
    ...
    init(service: String = "dev.mudbase.showcase.kanban") {
