...
/// Ported verbatim from the sibling Swift ports' `Networking/CollectionsGateway.swift`.
struct CollectionsGateway {
    ...
    func list(filter: [String: JSONValue] = [:], sort: String = "-createdAt", page: Int? = nil, limit: Int? = nil) async throws(ErrorResponse) -> ListResult {
        ...
        // transparently refreshes and retries once instead of surfacing a raw 401.
