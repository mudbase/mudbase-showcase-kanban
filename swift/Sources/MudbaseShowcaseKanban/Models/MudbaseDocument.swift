...
/// models (`BoardList`, `BoardCard`, `ActivityEntry`) build themselves from this rather than each
/// hand-rolling their own `DataListResponseDataInner`-vs-`JSONValue` branching. Ported verbatim
/// from the sibling Swift ports' `Models/MudbaseDocument.swift`.
